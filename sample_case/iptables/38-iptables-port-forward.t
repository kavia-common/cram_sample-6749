...
# Purpose: DNAT port-forwarding via UCI (temporary), verify via iptables-save
# Notes:
#  - Skip-safe if uci missing. Deterministic match and full cleanup.
